...
Для того, чтобы добавить новое место интереса можно либо использовать панель админа, либо использовать специальную команду `python load_place *ваша ссылка*.json` с содержанием, подобным [этому примеру](https://raw.githubusercontent.com/devmanorg/where-to-go-places/master/places/%D0%90%D0%BD%D1%82%D0%B8%D0%BA%D0%B0%D1%84%D0%B5%20Bizone.json).
